...
* the variance explained by the model is small
...
The resulting linear model has a *rmse* of `r basic_rmse_bc` in mg/min. The boxcox transform model does signficantly better than the basic models.

## Does adding stove type and fuel type as predictors improve the model?
