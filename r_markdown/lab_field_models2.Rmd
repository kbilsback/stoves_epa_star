...
```{r}
  saveRDS(intervals, "../r_files/wood_pm.RDS")
```
...
```{r}
  saveRDS(intervals, "../r_files/charcoal_pm.RDS")
```
...
```{r}
  saveRDS(intervals, "../r_files/wood_bc.RDS")
```
...
```{r}
  saveRDS(intervals, "../r_files/wood_co.RDS")
```
...
```{r}
  saveRDS(intervals, "../r_files/charcoal_cocrdrd<swws2 v4.RDS")
```
