  ...
  jetter_data <- 
    ...
    dplyr::mutate(stove = 
                    ...
                    forcats::fct_recode("rocket elbow (envirofit)" = "envirofit g3300",
                                        ...
                                        "ceramic charcoal (small) 1" = "ceramic charcoal",
                                        "ceramic charcoal (small) 2" = "kcj standard",
    ...
    dplyr::mutate(stove_cat =
                    ...
                    "traditional stoves" = c("three stone fire",
                                             "ceramic charcoal (small) 1",
                                             "ceramic charcoal (small) 2",
                  ...
                  test_type = ifelse(fuel == "charcoal", "batch-fed\ncharcoal protocol", NA),
