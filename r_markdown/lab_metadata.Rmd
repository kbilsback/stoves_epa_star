  ...
  samples <-
    ...
    dplyr::mutate(fuel = gsub("Wood Pellets", "Eucalyptus Pellets", fuel),
                  fuel_type = if_else(grepl("Lump Hardwood|Coconut Charcoal", fuel),
                                      "charcoal stove protocol", "wood stove protocol"),
                  fuel_type = if_else(grepl("Red Oak|Eucalyptus Pellets", fuel),
                                      "batch-fed wood stove protocol", fuel_type),
...
```{r}
  jetter_data <- 
    ...
    dplyr::mutate(stove_cat =
                  ...
                  fuel_type = ifelse(fuel == "charcoal", "charcoal fuels", fuel),
                  fuel_type = ifelse(fuel == "wood", "wood-based fuels", fuel_type))
```
