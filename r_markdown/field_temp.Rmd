...
```{r plot_all_temp_data, fig.width=12, fig.height=50}
  plot_timeseries_qc(dplyr::filter(field_temp_merged_all, var == "temp"))
```

## test data only

```{r plot_test_temp, fig.width=12, fig.height=50}
  plot_timeseries_qc(dplyr::filter(field_temp_merged, var == "temp"))
```

## test summary

```{r plot_test_temp, fig.width=12, fig.height=50}
  boxplot_timeseries_qc(dplyr::filter(field_temp_merged, var == "temp"))
```
