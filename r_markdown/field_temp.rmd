...
```{r bad_tests}
  field_temp_merged_all$qc[field_temp_merged_all$id == "IN10"] <- "bad"

  field_temp_merged_all$qc[field_temp_merged_all$id == "IN12"] <- "maybe"
  field_temp_merged_all$qc[field_temp_merged_all$id == "IN17"] <- "maybe"
  field_temp_merged_all$qc[field_temp_merged_all$id == "IN18"] <- "maybe"
