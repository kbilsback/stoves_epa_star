...
```{r}
  pm_est_stove <-
    pm_est %>%
    dplyr::left_join(dplyr::select(field_rates, id, pm_rate), by = c("id")) %>%
...
```{r, fig.width=8, figh.height=8}
  ...
  pm_est %>%
    ggplot() +
      ...
      geom_rect(mapping = aes(xmin = 0.5, xmax = 2.7, ymin = 0.5, ymax = 2.7),
                color = "8", fill = "darkgray", alpha = 0.008) +
      ...
      geom_rect(mapping = aes(xmin = 45, xmax = 1000, ymin = 45, ymax = 1000),
                color = "8", fill = "darkgray", alpha = 0.008) +
      geom_point(aes(pm_rate, pm_est, shape = stove, color = mod), size = 3, stroke = 1.5) +
      scale_shape_manual(values = c(8, 1, 4, 2, 5)) +
      ...
      scale_y_continuous(limits = c(0.5, 1000), breaks = c(1, 10, 100, 1000), trans = "log10") +
      scale_x_continuous(limits = c(0.5, 1000), breaks = c(1, 10, 100, 1000), trans = "log10") +
