...
```{r field_sumsarized} 
  #Load file durations for the data that was analyzed by Danny Wilson
  saveRDS(load_field_sumsarized("sensor_wise_csvs"), file = "../r_files/field_sumsarized_durations.RDS")
  ...
  #saveRDS(load_field_sumsarized("sumsarized"), file = "../r_files/field_sumsarized_timeseries.RDS")
```
...
```{r load_field_lascar} 
  saveRDS(load_field_lascar(), file = "../r_files/load_field_lascar")
```
