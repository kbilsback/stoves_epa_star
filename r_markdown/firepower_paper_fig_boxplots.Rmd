  ...
  plot %>%
    ggplot(aes(x = test_type, y = pm_ef)) +
      ...
      guides(color = guide_legend(override.aes = list(size = 3, alpha = 0.75,
                                                      shape = 16, linetype = 0))) +
      scale_y_continuous(breaks = c(0.05, 0.1, 0.5, 1, 5, 10),
                         labels = c(0.05, 0.1, 0.5, 1, 5, 10), trans = "log") +
      theme_bw() +
...
```{r fig_5b, fig.width=8, fig.height=3}
  plot %>%
