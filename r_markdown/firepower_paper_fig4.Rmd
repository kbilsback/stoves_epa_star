...
```{r, echo=FALSE}
  ...
  fix_predict <-
    ...
    dplyr::select(fst_type, id, sample_id, var, val, stove_fuel, stove, fuel, lhv) %>%
    ...
    dplyr::mutate(stove_fuel = forcats::as_factor(stove_fuel),
                  ...
                  test_type = forcats::as_factor(fst_type),
...
```{r, echo=FALSE, eval=FALSE}
  describeBy(dplyr::select(fix_predict, fp, mce, burn_rate, test_type), group = "fst_type")
```
...
```{r, echo=FALSE, eval=FALSE}
  describeBy(dplyr::select(rand_predict, sample_id, day, tester, rep, test_type), group = "fstt_type")
```
