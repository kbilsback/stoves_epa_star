    ...
    dplyr::mutate(stove = tolower(stove),
          ...
          dplyr::mutate(stove =
                          ...
                          forcats::fct_recode("Three-stone fire" = "three stone fire",
                                              ...
                                              "Ceramic plancha (1)" = "justa (artisan)",
                                              "Ceramic plancha (2)" = "sunken pot",
                                              "Mud chulha" = "clay ring",
                                              "Metal grill" = "vikram", 
                                              "Rocket elbow (1)" = "rocket elbow (g3300)",
                                              "Rocket elbow (2)" = "rocket elbow (chulika)",
                                              "Ceramic jiko (1)" = "ceramic jiko (small)",
                                              "Ceramic jiko (2)" = "ceramic jiko (large)",
                                              "Metal jiko (1)" = "metal jiko (small)",
                                              "Metal jiko (2)" = "metal jiko (large)",
                                              "Metal jiko (3)" = "metal jiko (burn)",
                                              "Forced-draft gasifier (1)" = "gasifier (philips)",
                                              "Forced-draft gasifier (2)" = "gasifier (doe)"),
                        fuel =
                          fuel %>%
                        ...
                        stove_cat = fct_collapse(stove,
                                                 "continuous-feed" = c("Three-stone fire",
                                                                  "Mud chulha",
                                                                  "Metal grill",
                                                                  "Rocket elbow (1)",
                                                                  "Rocket elbow (2)",
                                                                  "Metal plancha",
                                                                   "Ceramic plancha (1)",
                                                                  "Ceramic plancha (2)"),
                                                 "batch-fed" = c("Metal jiko (1)",
                                                                 "Metal jiko (2)",
                                                                 "Metal jiko (3)",
                                                                 "Ceramic jiko (1)",
                                                                 "Ceramic jiko (2)",
                                                                 "Forced-draft gasifier (1)",
                                                                 "Forced-draft gasifier (2)")))
```
...
```{r}
  ...
  saveRDS(samples2, "../r_files/lab_samples_v2.RDS")
