...
```{r sample_merge}
  ...
  aqe_merged_all <- dplyr::mutate(ecoc, date = replace(date, date == "2016-04-25", "2016-04-26")) %>%
...
```{r merge_bkgd}
  aqe_merged <- dplyr::left_join(aqe_merged, bkgd, by = c("field_site", "hh_id", "date", "units", "qc"))
```
