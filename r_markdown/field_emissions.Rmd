...
```{r, echo=FALSE, fig.height=10, fig.width=12,}
    ggplot(p_emissions, aes(x = firepower, y = val, colour = stove_type)) + 
    geom_point(size = 2) + 
...
```{r, echo=FALSE, fig.height=10, fig.width=12,}
    ggplot(p_emissions, aes(x = avg_temp, y = val, colour = stove_type)) + 
    geom_point(size = 2) + 
    facet_wrap(~var, scales = "free") + 
    theme_bw() +
    theme(legend.position = "top",
...
```{r, echo=FALSE, fig.height=10, fig.width=12,}
    ggplot(p_emissions, aes(x = prct95, y = val, colour = stove_type)) + 
    geom_point(size = 2) + 
    facet_wrap(~var, scales = "free") + 
    theme_bw() +
    theme(legend.position = "top",
