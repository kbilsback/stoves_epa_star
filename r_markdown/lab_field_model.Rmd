...
* models in the process of being built
...
```{r, fig.height=8, fig.width=15}
  lapply(f, function(x) plot_boxcox_model_2(data = lab_data, eqn = x))
```
...
```{r}
  predict_field_data <- lapply(f, function(y) lapply(pols, function(x)
                             predict_boxcox_model2(train_data = lab_data, test_data = field_data,
                                                  eqn = y, pollutant = x,
