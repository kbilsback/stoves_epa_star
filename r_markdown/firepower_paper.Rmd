...
The resulting mfp model has a *rmse* of `r basic_rmse` in g/kg. Although, mce is not selected as a significant variable. 
...
The resulting mfp model has a *rmse* of `r basic_rmse` in g/kg. Firepower is chosen to the first power and mce is not chosen as an important variable.
